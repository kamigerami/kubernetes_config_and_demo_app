...
namespace Worker
{
    public class Program
    {
        public static int Main(string[] args)
        {
            try
            {
                string pg_host = Environment.GetEnvironmentVariable("DB_SERVICE_HOST");
                string pg_pw = Environment.GetEnvironmentVariable("POSTGRES_PASSWORD");
                ...
                var pgsql = OpenDbConnection("Server="+pg_host+";Username="+pg_user+";Password="+pg_pw+";Database="+pg_db);
